...
internal sealed class BankAccountSelectionForm : Form
{
    ...
    private void LoadSelectedExisting()
    {
        ...
        _accountType.SelectedIndex = account.Type switch
        {
            BankAccountType.Courant => 0,
            BankAccountType.Epargne => 1,
            BankAccountType.CarteDifferee => 2,
            _ => 3
        };
    }
    ...
    private void SaveAndClose()
    {
        ...
        account.Holder = _holder.Text.Trim();
        account.Type = _accountType.SelectedIndex switch
        {
            0 => BankAccountType.Courant,
            1 => BankAccountType.Epargne,
            2 => BankAccountType.CarteDifferee,
            _ => BankAccountType.Autre
        };

        SelectedAccount = BankingRepository.SaveAccount(account);
    ...
    {
        layout.Controls.Add(new Label { Text = caption, Dock = DockStyle.Fill, TextAlign = ContentAlignment.MiddleLeft, ForeColor = Color.FromArgb(183, 207, 229) }, 0, row);
